...
timeline
    title 智能体发展时间线
    1950s-1970s : 符号主义智能体<br/>- 专家系统<br/>- 逻辑推理<br/>- 规则引擎
    1980s-1990s : 强化学习智能体<br/>- Q-Learning<br/>- 行为主义<br/>- 游戏AI
    2000s-2010s : 概率推理与贝叶斯智能体<br/>- 贝叶斯网络<br/>- 部分可观测MDP<br/>- 多智能体系统
    2010s-2020s : 深度强化学习智能体<br/>- DQN/DQN变种<br/>- AlphaGo<br/>- 多智能体强化学习
    2020s-至今 : 大语言模型驱动的智能体<br/>- GPT/Claude等LLM<br/>- ReAct/CoT等范式<br/>- 自主智能体
```
...
timeline
    title 游戏开发中的NPC演进
    1980s : 规则NPC<br/>"如果玩家有任务，显示对话框"<br/>• 预设对话脚本<br/>• 简单的条件触发<br/>• 无自主性
    1990s : 学习NPC<br/>"通过战斗学会最佳策略"<br/>• 基础强化学习<br/>• 行为模式优化<br/>• 策略适应性
    2000s : 复杂AI<br/>"使用状态机和行为树"<br/>• 状态机管理<br/>• 行为树结构<br/>• 复杂行为组合
    2020s : 智能NPC<br/>"你好，冒险者！听说你在寻找巨龙..."<br/>• 大语言模型驱动<br/>• 自然语言交互<br/>• 动态对话生成
    2030s : 自主世界<br/>"整个游戏世界由Agent驱动"<br/>• 多智能体系统<br/>• 自主决策<br/>• 涌现性故事
```
