...
AI Agent 协作开发游戏演示平台 - 展示 4 个 AI Agent 扮演不同游戏开发角色，通过会议讨论的方式协作开发游戏《九十九亿大战》。

## 📋 项目概述

游戏小镇是一个展示 AI Agent 协作能力的演示项目。四个 AI Agent 分别扮演：
- 🎯 **David** - 制作人：负责项目整体规划和进度管理
- 💻 **Alex** - 程序员：负责技术架构和系统开发
- 📋 **Emma** - 策划：负责玩法设计和数值平衡
- 🎨 **Luna** - 美术：负责视觉风格和美术资源
...
- 👤 **角色详情** - 点击团队成员查看详细信息弹框
- 📝 **会议总结弹框** - 会议结束后自动弹出总结文档，包含讨论要点和开发排期

### 会议场景
- **游戏是否好玩讨论** - 评估游戏核心乐趣，分析留存率和玩家反馈
- **原型Demo节点展示内容** - 讨论Demo评审的展示内容和分工
...
在 `backend/app/config.py` 中修改 `AGENT_ROLES` 配置：
